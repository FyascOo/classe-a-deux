...
export class ButtonCircleComponent {
  @Input() set style({ hover, hoverBorder, hoverText, focus, backgroundColor }: StyleCircle) {
  ...
  _style = 'hover:bg-[#6ba0a5] hover:border-[#6ba0a5] hover:text-white focus:ring-[#6ba0a5] bg-white';
}
